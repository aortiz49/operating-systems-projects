...
public class D extends Thread {
    ...
    private boolean validoAlgHMAC(String nombre) {
        return ((nombre.equals(S.HMACMD5) || nombre.equals(S.HMACSHA1) || nombre
                .equals(S.HMACSHA256) || nombre.equals(S.HMACSHA384) || nombre
                .equals(S.HMACSHA512)));
    }
    ...
    private synchronized void logTime(String pCadena) {
    ...
    public void run() {
        ...
        try {
            ...
            if (!algoritmos[1].equals(S.DES) && !algoritmos[1].equals(S.AES) && !algoritmos[1]
            ...
            try {
                ...
                certificadoCliente =
                        (X509Certificate) creador.generateCertificate(in);
            ...
            SecretKey simetrica = null;
            try {
                simetrica = S.kgg(algoritmos[1]);
                byte[] ciphertext1 = S.ae(simetrica.getEncoded(), certificadoCliente.getPublicKey(),
                                          algoritmos[2]);
                ...
                linea = dc.readLine();
                byte[] retodelcliente =
                        S.ad(toByteArray(linea), keyPairServidor.getPrivate(), algoritmos[2]);
